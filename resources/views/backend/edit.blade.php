        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  <?php
                    $b = DB::table('consoles')->where('ConsoleID', $id)->first();
                  ?>
                    <!-- Page Heading -->
                    <!-- Content Row -->
                    <div class="row">
                      <form action="/dashboard/product/edit/{{$b->ConsoleID}}" method="post" enctype="multipart/form-data" >
                        @csrf
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="deskripsi" rows="4" cols="50">{{$b->Descrip}}</textarea required>
                          </div>
                          <div class="form-group">
                            <label>Price</label>
                          ...
                          <button type="button" class="btn btn-danger"><a href="/dashboard/product">Batal</a></button>
